...
func newTestEnv(t *testing.T) *testEnv {
	...
	srv := api.New(cfg, jobRepo, fileRepo, tokenRepo, tagRepo, cookieRepo, repo.NewSettingsRepo(database), repo.NewCollectionRepo(database), storage.New(tmpDir), &fakePool{}, sse.New())
